...
\begin{solution}
	...
	\begin{align*}
		F(x,t) & \le 0
	\end{align*}
	Therefore, by \nameref{thm:Maximum_Principle_for_Heat_Equation}, $\max\limits_{0 \le x \le 1 , 0 \le t \le 1} u(x,t)$ is on the boundary of the domain, excluding $t = 1$.\\
	Therefore,
	\begin{align*}
...
\begin{solution}
	...
	\begin{align*}
		F(x,t) & \le 0
	\end{align*}
	Therefore, by \nameref{thm:Maximum_Principle_for_Heat_Equation},
	\begin{align*}
...
\begin{solution}
	By \nameref{thm:Solution_to_the_Cauchy_Problem_for_the_Heat_Equation},
	\begin{align*}
